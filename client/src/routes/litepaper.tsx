...
export default function Litepaper() {
    return (
        <div className="flex flex-col w-full h-screen overflow-hidden pb-[env(safe-area-inset-bottom)] text-white">
                ...
                <main className="container mx-auto px-4 py-12 max-w-4xl">
                    <article className="prose prose-invert prose-lg">
                        <h1 className="text-4xl font-bold mb-8 bg-clip-text text-transparent bg-gradient-to-r from-white to-secondary drop-shadow-[0_0_15px_rgba(255,255,255,0.3)]">
                            Synp: A Decentralized AI Infrastructure for Creating
                            and Connecting AI Agents
                        </h1>
                        ...
                        <section className="mb-12">
                            ...
                            <p className="text-gray-300">
                                Synp is an innovative platform that redefines
                                how AI agents are created, managed, and
                                connected. Inspired by the concept of synapses
                                in the human brain, Synp enables users to design
                                their own AI agents through simple prompts,
                                supervise these agents via a centralized
                                dashboard, and eventually connect them to form
                                collaborative agent networks. With future
                                blockchain integration, Synp aims to build a
                                decentralized infrastructure for transparency,
                                traceability, and AI agent autonomy.
                            </p>
                        </section>
                        ...
                        <section className="mb-12">
                            ...
                            <p className="text-gray-300">
                                To provide a simple, powerful, and decentralized
                                platform that enables users to create, manage,
                                and connect their AI agents for complex and
                        ...
                        <section className="mb-12">
                            ...
                            <p className="text-gray-300">
                                Synp will leverage HyperEVM, an innovative L1
                                developed by Hyperliquid. This blockchain
                                infrastructure offers high performance and
                                reduced transaction fees, making it ideal for
                                managing agent identities and on-chain
                                interactions. By using HyperEVM, Synp ensures
                                optimal scalability and compatibility with
                                industry standards while paving the way for
                                widespread adoption of decentralized AI agents.
                            </p>
                            <p className="text-gray-300 mt-4">
                                Hypurr.fun and the SYNP Token Synp will launch
                                its native token, SYNP, on Hypurr.fun, a
                                next-generation decentralized platform designed
                                for token launches and community engagement. The
                                SYNP token will play a pivotal role in the Synp
                                ecosystem, enabling governance, incentivizing
                                participation, and facilitating transactions
                                within the platform. Additionally, 5% of the
                                total supply of SYNP will be reserved to ensure
                                the sustainability of the project and to cover
                                potential operational costs. By leveraging
                                Hypurr.fun, Synp ensures a fair and accessible
                                launch for its token, aligning with its
                                decentralized ethos.
                            </p>
                        </section>
                        ...
                        <section className="mb-12">
                            ...
                            <p className="text-gray-300">
                                Synp aspires to become the global standard for
                                creating and managing connected AI agents,
                                combining artificial intelligence and blockchain
                                technology to develop a decentralized AI agent
                                network.
                            </p>
                        </section>
                        ...
                        <section className="mb-12">
                            ...
                            <p className="text-gray-300">
                                Synp represents a new era of collaboration
                                between artificial intelligence and
                                decentralized technologies. With an intuitive
                                interface, innovative features, and a vision
                                centered on transparency and connectivity, Synp
                                paves the way for a future where AI agents work
                                together to address complex needs within a
