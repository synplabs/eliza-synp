      ...
      <div className="flex items-center justify-between px-4">
        <div className="flex items-center gap-4">
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <Link
              to="/litepaper"
              className="text-sm text-white font-bold transition-all hover:text-[#00D2BE] hover:drop-shadow-[0_0_12px_rgba(0,210,190,0.5)]"
            >
              LITEPAPER
            </Link>
          </div>
        ...
        <div className="hidden md:flex items-center gap-2">
          <a href="https://x.com/synp_ai" target="_blank" className="group">
